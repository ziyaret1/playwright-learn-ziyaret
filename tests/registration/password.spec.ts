...
test.describe("Password Suite", () => {
    ...
    test("[AQAPRACT-530] Register with empty Password field", async ({ registerPage }) => {
    ...
    test("[AQAPRACT-533] Register with empty Confirm password field", async ({ registerPage }) => {
        const passwordData: string = "TestConf11";
        await registerPage.fillPassword(passwordData);
