...
export class UserProfilePage extends BasePage {
    ...
    readonly calendarMonthTitle: Locator;
    readonly calendarRightArrow: Locator;
    readonly calendarLeftArrow: Locator;
    readonly selectedDayFromCalendar: Locator;
    // Dropdown menu
    ...
    constructor(page: Page) {
        ...
        /// Calendar
        this.calendarModal = page.locator(
            'div.fixed.inline-block.border.shadow-lg.rounded-md.bg-white'
        );
        this.calendarMonthTitle = page.locator('div.text-lg span');
        this.calendarRightArrow = page.locator('img[alt="arrow_right"]');
        this.calendarLeftArrow = page.locator('img[alt="arrow_left"]');
        this.selectedDayFromCalendar = page.locator('.flex.justify-center.items-center span', {
            hasText: '15',
        });
        // Dropdown menu
        ...
        this.inputRequiredErrorMessage = page.locator('span.text-rose-500:text("Required")');
